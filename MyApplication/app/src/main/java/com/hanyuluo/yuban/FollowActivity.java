...
public class FollowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_follow);
    ...
    private void getData(String userid) {
        ...
        //关注数
        String url2="http://39.97.251.92:8000/home/api/user/followed/"+userid;
        //第一步获取okHttpClient对象
        ...
        call2.enqueue(new Callback() {
            ...
            public void onResponse(Call call2, Response response) throws IOException {
                ...
                FollowActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mAdapter = new LoginuserAdapter(FollowActivity.this,loginusers2);
