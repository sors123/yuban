...
public class ReadActivity extends AppCompatActivity {
    ...
    private  void getData(String userid) {
        ...
        //关注数
        String url2="http://39.97.251.92:8000/home/api/user/read/"+userid;
        //第一步获取okHttpClient对象
        ClearableCookieJar cookieJar =
                new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(ReadActivity.this));
